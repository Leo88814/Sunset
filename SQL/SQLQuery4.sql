USE [master]
GO
/****** Object:  Database [BookMovie]    Script Date: 2024/9/24 上午 09:16:26 ******/
...
USE [BookMovie]
GO
/****** Object:  User [sa5]    Script Date: 2024/9/24 上午 09:16:26 ******/
CREATE USER [sa5] FOR LOGIN [sa5] WITH DEFAULT_SCHEMA=[dbo]
GO
ALTER ROLE [db_owner] ADD MEMBER [sa5]
GO
/****** Object:  Table [dbo].[Auditoriums]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Cinemas]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CustomerService]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Members]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieGenres]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieImages]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieRatings]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieReleaseSchedules]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Movies]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetails]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Seats]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Showtimes]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Topups]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TransactionHistory]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 2024/9/24 上午 09:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (1, 1, 1, 1, 4)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (2, 2, 2, 2, 5)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (3, 3, 3, 3, 3)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (4, 4, 4, 4, 5)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (5, 5, 5, 5, 4)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (6, 6, 6, 6, 5)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (7, 7, 7, 7, 4)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (8, 8, 8, 8, 3)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (9, 9, 9, 9, 4)
GO
INSERT [dbo].[MovieRatings] ([Id], [MemberId], [MovieId], [OrderId], [Rating]) VALUES (10, 10, 10, 10, 5)
GO
SET IDENTITY_INSERT [dbo].[MovieRatings] OFF
GO
SET IDENTITY_INSERT [dbo].[MovieReleaseSchedules] ON 
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (1, 1, 1, 1, CAST(N'2023-05-17' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (2, 2, 2, 2, CAST(N'2023-06-02' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (3, 3, 3, 3, CAST(N'2023-04-05' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (4, 4, 1, 4, CAST(N'2023-07-21' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (5, 5, 2, 5, CAST(N'2023-07-21' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (6, 6, 3, 6, CAST(N'2023-03-24' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (7, 7, 1, 7, CAST(N'2023-05-03' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (8, 8, 2, 8, CAST(N'2023-06-09' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (9, 9, 3, 9, CAST(N'2023-02-17' AS Date))
GO
INSERT [dbo].[MovieReleaseSchedules] ([Id], [MovieId], [AuditoriumId], [ShowtimeId], [ReleaseDate]) VALUES (10, 10, 1, 10, CAST(N'2023-03-10' AS Date))
GO
SET IDENTITY_INSERT [dbo].[MovieReleaseSchedules] OFF
GO
SET IDENTITY_INSERT [dbo].[Movies] ON 
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (1, 1, 1, N'玩命關頭10', N'Fast X', N'輔導級', N'唐老大一家人將面臨最致命的對手', N'https://youtu.be/32RAq6JzY-w', CAST(N'2023-05-17' AS Date), 1, N'路易斯·萊特里爾', N'馮·迪索, 傑森·史塔森, 米雪兒·羅德里奎茲', N'英語', N'141分鐘', N'環球影業', N'/images/fastx_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (2, 2, 2, N'蜘蛛人：穿越新宇宙', N'Spider-Man: Across the Spider-Verse', N'保護級', N'邁爾斯·莫拉雷斯展開多重宇宙冒險', N'https://youtu.be/shW9i6k8cB0', CAST(N'2023-06-02' AS Date), 1, N'瓦昆·杜斯·山托斯, 凱普·鮑爾斯, 賈斯汀·K·湯普森', N'沙梅克·摩爾, 海莉·斯坦菲爾德, 奧斯卡·伊薩克', N'英語', N'140分鐘', N'索尼影業', N'/images/spiderman_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (3, 3, 3, N'超級瑪利歐兄弟電影版', N'The Super Mario Bros. Movie', N'普遍級', N'瑪利歐兄弟的冒險旅程', N'https://youtu.be/TnGl01FkMMo', CAST(N'2023-04-05' AS Date), 1, N'亞倫·霍瓦斯, 麥可·傑勒尼克', N'克里斯·帕拉特, 安雅·泰勒喬伊, 傑克·布萊克', N'英語', N'92分鐘', N'環球影業', N'/images/mario_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (4, 4, 4, N'奧本海默', N'Oppenheimer', N'輔導級', N'原子彈之父的傳記電影', N'https://youtu.be/uYPbbksJxIg', CAST(N'2023-07-21' AS Date), 1, N'克里斯多福·諾蘭', N'基里安·墨菲, 艾蜜莉·布朗特, 麥特·戴蒙', N'英語', N'180分鐘', N'環球影業', N'/images/oppenheimer_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (5, 5, 5, N'芭比', N'Barbie', N'保護級', N'芭比娃娃的真人電影', N'https://youtu.be/pBk4NYhWNMM', CAST(N'2023-07-21' AS Date), 1, N'葛莉塔·潔薇', N'瑪格·羅比, 萊恩·葛斯林, 威爾·法洛', N'英語', N'114分鐘', N'華納兄弟', N'/images/barbie_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (6, 1, 6, N'捍衛任務4', N'John Wick: Chapter 4', N'輔導級', N'約翰·威克的最後一戰', N'https://youtu.be/qEVUtrk8_B4', CAST(N'2023-03-24' AS Date), 1, N'查德·史塔赫斯基', N'基努·李維, 甄子丹, 比爾·斯卡斯加德', N'英語', N'169分鐘', N'獅門影業', N'/images/johnwick4_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (7, 2, 7, N'星際異攻隊3', N'Guardians of the Galaxy Vol. 3', N'保護級', N'星際異攻隊的最後冒險', N'https://youtu.be/u3V5KDHRQvk', CAST(N'2023-05-03' AS Date), 1, N'詹姆斯·岡恩', N'克里斯·帕拉特, 柔伊·莎達娜, 戴夫·巴蒂斯塔', N'英語', N'150分鐘', N'迪士尼', N'/images/gotg3_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (8, 3, 8, N'變形金剛：萬獸崛起', N'Transformers: Rise of the Beasts', N'保護級', N'全新的變形金剛冒險', N'https://youtu.be/itnqEauWQZM', CAST(N'2023-06-09' AS Date), 1, N'史蒂芬·卡普爾', N'安東尼·拉莫斯, 多明尼克·菲什巴克, 蘿倫·維萊茲', N'英語', N'127分鐘', N'派拉蒙', N'/images/transformers_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (9, 4, 9, N'蟻人與黃蜂女：量子狂熱', N'Ant-Man and the Wasp: Quantumania', N'保護級', N'蟻人家族的量子冒險', N'https://youtu.be/5WfTEZJnv_8', CAST(N'2023-02-17' AS Date), 1, N'佩頓·里德', N'保羅·路德, 伊凡潔琳·莉莉, 強納森·梅傑斯', N'英語', N'124分鐘', N'迪士尼', N'/images/antman3_main.jpg')
GO
INSERT [dbo].[Movies] ([Id], [GenerId], [MovieImageId], [MovieName], [EnglishName], [Grading], [description], [TrailerURL], [PremiereDate], [OnAir], [Director], [Cast], [Language], [Duration], [Distributor], [MainPicture]) VALUES (10, 5, 10, N'驚聲尖叫6', N'Scream VI', N'輔導級', N'在紐約市展開的新一輪殺戮', N'https://youtu.be/h74AXqw4Opc', CAST(N'2023-03-10' AS Date), 1, N'麥特·貝提內里-奧爾平, 泰勒·吉列特', N'梅莉莎·巴雷拉, 賈斯敏·薩沃伊·布朗, 梅森·古丁', N'英語', N'123分鐘', N'派拉蒙', N'/images/scream6_main.jpg')
GO
...
GO
INSERT [dbo].[OrderDetails] ([Id], [OrderId], [SeatId], [TicketType], [TicketPrice], [TicketNumber]) VALUES (2, 2, 2, N'優待票', CAST(250 AS Decimal(10, 0)), N'B002')
GO
...
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (1, 1, 1, CAST(N'2023-05-17T10:00:00.000' AS DateTime), CAST(300 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (2, 2, 2, CAST(N'2023-06-02T11:00:00.000' AS DateTime), CAST(250 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (3, 3, 3, CAST(N'2023-04-05T12:00:00.000' AS DateTime), CAST(200 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (4, 4, 4, CAST(N'2023-07-21T13:00:00.000' AS DateTime), CAST(350 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (5, 5, 5, CAST(N'2023-07-21T14:00:00.000' AS DateTime), CAST(300 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (6, 6, 6, CAST(N'2023-03-24T15:00:00.000' AS DateTime), CAST(250 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (7, 7, 7, CAST(N'2023-05-03T16:00:00.000' AS DateTime), CAST(200 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (8, 8, 8, CAST(N'2023-06-09T17:00:00.000' AS DateTime), CAST(350 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (9, 9, 9, CAST(N'2023-02-17T18:00:00.000' AS DateTime), CAST(300 AS Decimal(10, 0)), N'已付款')
GO
INSERT [dbo].[Orders] ([Id], [MemberId], [ShowtimeId], [OrderDate], [TotalAmount], [PaymentStatus]) VALUES (10, 10, 10, CAST(N'2023-03-10T19:00:00.000' AS DateTime), CAST(280 AS Decimal(10, 0)), N'已付款')
GO
...
GO
INSERT [dbo].[Topups] ([Id], [MemberId], [TopUpAmount], [OrderTime]) VALUES (1, 1, CAST(1000 AS Decimal(10, 0)), CAST(N'2023-05-01T10:00:00.000' AS DateTime))
GO
INSERT [dbo].[Topups] ([Id], [MemberId], [TopUpAmount], [OrderTime]) VALUES (2, 2, CAST(500 AS Decimal(10, 0)), CAST(N'2023-05-02T11:00:00.000' AS DateTime))
GO
INSERT [dbo].[Topups] ([Id], [MemberId], [TopUpAmount], [OrderTime]) VALUES (3, 3, CAST(1500 AS Decimal(10, 0)), CAST(N'2023-05-03T12:00:00.000' AS DateTime))
GO
INSERT [dbo].[Topups] ([Id], [MemberId], [TopUpAmount], [OrderTime]) VALUES (4, 4, CAST(800 AS Decimal(10, 0)), CAST(N'2023-05-04T13:00:00.000' AS DateTime))
GO
INSERT [dbo].[Topups] ([Id], [MemberId], [TopUpAmount], [OrderTime]) VALUES (5, 5, CAST(2000 AS Decimal(10, 0)), CAST(N'2023-05-05T14:00:00.000' AS DateTime))
GO
